<template>
	<section class="blog" id="blog">
		<div class="grid-blog">
			 <h2 class="blog__title"><router-link class="blog__title" to="/blog/home/">Visite nosso blog
			</router-link></h2>
            ...
            id: category.id}}" class="blog__card-img">
					<img class="blog__img" :src="category.image" :alt="category.title">
				</router-link>
			<h3 class="blog__title" >
				<router-link class="blog__card-title" :to="{name: 'ShowSubs', query: {
            category: category.slug.toLowerCase(),
