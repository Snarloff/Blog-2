  ...
  export default {
    data(){
      return {
        ...
        categoryTitle: this.capitalizeFirstLetter(this.$route.query.category.trim()),
    ...
    watch: {
      '$route.query.category': function(){
        ...
        this.categoryTitle = this.capitalizeFirstLetter(this.$route.query.category.trim())
