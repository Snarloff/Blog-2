<template>
  <div class="privacy">
    ...
    <p>
      ...
      <a href="www.miguelceccarelli.com">Miguel Ceccarelli</a>, e outros sites
    ...
    <h2>Política de Cookies Miguel Ceccarelli</h2>
    ...
    <ul>
      ...
      <li>
        ...
        recursos e áreas restritas ao efetuar login.<br /><br />
      </li>
      <li>
      ...
      <li>
        ...
        entre as páginas, para que possamos processá-lo adequadamente.<br /><br />
      </li>
      <li>
        ...
        precisos após a alteração das páginas.<br /><br />
      </li>
      <li>
      ...
      <li>
        ...
        que você interagir com uma página for afetada por suas preferências.<br />
      </li>
    </ul>
    ...
    <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se
    ...
    <h2>1. Termos</h2>
    <p>Ao acessar ao site
      <a href="www.miguelceccarelli.com">Miguel Ceccarelli</a>, concorda em
